...
import { 
  ...
  Pencil, X, Camera, Save, Settings, Briefcase, Gamepad2, Clapperboard, UserPlus, Lightbulb, Gift, Radio, ShoppingBag, Wallet, CreditCard
} from 'lucide-react';
...
export default function Sidebar({
  ...
  const navItems = [
    ...
    { id: 'buy_credits', name: 'Comprar Créditos', icon: CreditCard, color: 'text-[#B39DFF] font-black' },
    ...
    { id: 'ideas', name: 'Exponha suas ideias', icon: Lightbulb, color: 'text-yellow-400 font-extrabold' },
